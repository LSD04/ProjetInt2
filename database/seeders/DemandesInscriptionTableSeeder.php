    ...
    public function run()
    {
        DB::table('demandes_inscription')->insert([
            ...
            [
                'nom' => 'Morinville',
                'prenom' => 'Jonathan',
                'adresse_email' => 'jonathan.morinville@email.com', // Assurez-vous que cette adresse est unique
                'date_demande' => Carbon::now()->format('Y-m-d H:i:s'),
                'local_id' => 1, // Assurez-vous que cet ID existe dans votre table `locals`
                'statutDemande' => 'en attente',
                'utilisateur_id' => 2, // Assurez-vous que cet ID existe dans votre table `utilisateurs`
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ]
        ]);
